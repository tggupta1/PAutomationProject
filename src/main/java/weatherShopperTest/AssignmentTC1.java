...
public class AssignmentTC1 extends BaseTest {
	...
	@Test()
	@Parameters("Browser")
	public void verifyWeatherShopperEndToEnd_T1(String browser) throws InterruptedException {
		try {
			bs = new BaseSetup();
			ExtentTest test = report.startTest("verifyWeatherShopperEndToEnd_T1");
